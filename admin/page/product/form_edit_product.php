...
?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> เเก้ไขข้อมูลหน้าสินค้า</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-table"></i>Table</li>
              <li><i class="fa fa-th-list"></i>แก้ไขข้อมูลหน้าสินค้า</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <form role="form">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">adminที่เเก้ข้อความ</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
                  <!-- <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary">เเก้ไขข้อมูลสินค้า</button>
                </form>
